...
public class CURD {
    ...
    public CURD(HashMap<Integer, String> emp) {
    ...
    public void updateEmployeeDetail(@PathVariable(value = "id") int id, @RequestBody Person person){
        ...
        emp.put(id,new Person(person.getName()!=null?person.getName():this.emp.get(id).getName(),person.getEmail()!=null?person.getEmail():this.emp.get(id).getEmail()));
